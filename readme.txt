...
Svetoslav Marinov (Slavi) | <a href="http://Orbisius.com/?utm_source=wp-notes-remover&utm_term=readme" title="Custom Web Programming, Web Design, e-commerce, e-store, WordPress Plugin Development, Facebook and Mobile App Development in Niagara Falls, St. Catharines, Ontario, Canada" target="_blank">Custom Web and Mobile Programming by Orbisius.com</a>
...
= Manual Installation =
1. Upload the .zip into to the `/wp-content/plugins/` directory
...
Run into issues or have questions/suggestions? Send post them in http://club.orbisius.com/forums/forum/community-support-forum/wordpress-plugins/wp-notes-remover/

== Screenshots ==
1. Default view "Remove You may use these HTML tags and attributes"
2. "Remove You may use these HTML tags and attributes" are removed indeed
